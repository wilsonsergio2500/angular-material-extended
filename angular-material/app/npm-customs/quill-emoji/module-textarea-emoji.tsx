...
export class TextAreaEmoji {
    ...
    constructor(public quill : Quill.Quill) {
        ...
        (this.quill as any).container.appendChild(this.container);
    ...
    checkEmojiBoxExist() {
        ...
        if (elementExists) {
            ...
            (this.quill as any).container.appendChild(ele_emoji_area);
            ...
            emojiType.map(function (emojiType) {
                ...
                emojiFilter.addEventListener('click', function () {
                    ...
                    let type = (emojiFilter as any).dataset.filter;
                    fn_emojiElementsToPanel(type, panel, innerQuill);
                })
            });

            let windowHeight = window.innerHeight;
            let editorPos = (this.quill as any).container.getBoundingClientRect().top;
...
function fn_updateRange(quill : Quill.Quill) {
    let range = quill.getSelection();
    return range;
}

function fn_emojiPanelInit(panel : any, quill : Quill.Quill) {
