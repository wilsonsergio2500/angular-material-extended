 ...
 */
function addIfNotPresent(nodes : any, attr : any, val : any) {
 ...
 */
function getNgModelNodes(node : any) {
 ...
 */
export function ngModelAttrsManipulator(template : any, options : any, attrName : any, attrValue? : any) {
 ...
 */
export function ngModelAttrsTransformer(fields : any, condition : any, name : any, settings : any) {
