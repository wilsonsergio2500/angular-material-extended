...
declare namespace ngRoute {
    ...
    interface IRoute {
         ...
         */
        template?: string | { ($routeParams?: ngRoute.IRouteParamsService): string; }
        /**
         * {string=|function()=}
         ...
         * {Array.<Object>} - route parameters extracted from the current $location.path() by applying the current route
         */
        templateUrl?: string | { ($routeParams?: ngRoute.IRouteParamsService): string; }
        /**
         ...
         */
        redirectTo?: string | { ($routeParams?: ngRoute.IRouteParamsService, $locationPath?: string, $locationSearch?: any): string };
        /**
