...
(function (Configuration) {
    var Config = (function () {
        function Config($mdThemingProvider, $stateProvider, $stateHelperProvider, $urlRouterProvider, formlyConfigProvider) {
        ...
        Config.$inject = ['$mdThemingProvider', '$stateProvider', '$stateHelperProvider', '$urlRouterProvider', 'formlyConfigProvider'];
        return Config;
    }());
