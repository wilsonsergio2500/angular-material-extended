...
(function (Services) {
    ...
    var MilestoneService = (function () {
        ...
        MilestoneService.prototype.Get = function (id) {
            return this.HttpService.get(basePath + "/record/item/" + id, {});
        };
        ...
        MilestoneService.prototype.GetListByCategory = function (userId, categoryId, request) {
            return this.HttpService.get(basePath + "/record/category/" + userId + "/" + categoryId + "/" + request.skip + "/" + request.take);
        };
